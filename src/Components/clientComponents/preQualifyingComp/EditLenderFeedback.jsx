...
const EditLenderFeedback = ({
  ...
  const [checkedOne, setCheckedOne] = useState(
    form.conditions?.find((e) => e.key === "isPreAproved")?.value === true
      ? "Pre-Aproved"
      : "Need-to-work"
  );
        ...
        <>
          <div className="managerInputsubContainer" style={{ width: "60vw" }}>
            <div className="inputDiv">
              ...
              <input
                defaultValue={
                  form.attributes.find((e) => e.key === "currentCreditScore")
                    .value
                }
                type="number"
            ...
            <div className="inputDiv">
              ...
              <input
                defaultValue={
                  form.attributes.find((e) => e.key === "preApprovedAmount")
                    ?.value
                }
            ...
            <div className="inputDiv">
              ...
              <input
                defaultValue={
                  form.attributes.find((e) => e.key === "typeOfLoan")?.value
                }
                placeholder="Type amount..."
                onChange={(e) => {
                  const form2 = form;
            ...
            <div className="inputDiv">
              ...
              <input
                defaultValue={
                  form.attributes.find((e) => e.key === "downPaymentAmount")
                    ?.value
                }
          ...
          <div className="managerInputsubContainer" style={{ width: "60vw" }}>
            <div className="inputDiv">
              ...
              <input
                defaultValue={
                  form.attributes.find((e) => e.key === "estimatedCash")?.value
                }
                type="number"
            ...
            <div className="inputDiv">
              ...
              <textarea
                defaultValue={
                  form.attributes.find((e) => e.key === "notesLenderFeedback")
                    ?.value
                }
          ...
          <>
            <div className="managerInputsubContainer" style={{ width: "60vw" }}>
              ...
              <div className="inputDiv">
                ...
                <input
                  defaultValue={
                    form.attributes.find((e) => e.key === "didYouRunCS")?.value
                  }
                  placeholder="Type..."
                  onChange={(e) => {
                    const form2 = form;
...
export default EditLenderFeedback;
